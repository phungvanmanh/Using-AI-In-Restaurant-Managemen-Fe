<template>
    <button :type="type" :style="style" :class="'me-2 btn btn-' + color" :class="classNew" data-bs-toggle="modal" :data-bs-target="'#' + titleId"  @click="handleClick">
        {{ label }}
    </button>
    <Teleport to="body">
...
export default {
    ...
    props : {
        ...
        color : {
            ...
            default : 'primary',
            validator(value) {
                return ['primary', 'danger', 'success', 'secondary', 'warning', 'light', 'dark', 'info'].includes(value)
            }
        },
        type : {
            type: String,
