                                ...
                                <tr>
                                    ...
                                    <td class="text-center align-middle text-nowrap">
                                        <ModalComponent color="success" label="Edit Table" titleId="edit_table"
                                            ...
                                            <template #modal-body>
                                                <InputComponent v-model="editCotegory.name_table"
                                                    @keyup="convertToSlug(editCotegory)" label="Name table"
                                                    placeholder="Enter the table name..." />
                                                <InputComponent v-model="editCotegory.slug_table" label="Slug table" :disabled="true" />
                                        ...
                                        <ModalComponent color="danger" label="Delete Table" titleId="delete_table"
                                            ...
                                            <template #modal-body>
                                                ...
                                                <span class="text-danger"><b><i>{{ deleteCotegory.name_table}}</i></b></span>
                                                section?
                                            </template>
                                            <template #modal-footer>
...
export default {
    ...
    setup() {
        ...
        return { area, status, addTable, dataBan, convertToSlug, addNew, changeStatus, updateBan, deleteBan };
    },
};
</script>
