                        ...
                        <template #tbody>
                            <template v-for="(value, key) in dataBan" :key="key">
                                <tr>
                                    ...
                                    <th class="text-center align-middle text-nowrap">{{ value.name_table }}</th>
                                    <th class="text-center align-middle text-nowrap">{{ value.slug_table }}</th>
                                    <th class="text-center align-middle text-nowrap">{{ value.name_area }}</th>
                                    <th class="text-center align-middle text-nowrap">Status</th>
                                    <th class="text-center align-middle text-nowrap">Action</th>
                                </tr>
                            </template>
